...
<head>
	...
	<link rel="icon" type="image/png" href="css/Images/logo1.png">
    <title>ABC Manufacturing</title>
</head> 
<body>
    <div id="loader"></div>
    <div class="container1">
        <img src="css/Images/icon1.png" alt="Icon" class="icon1">
    </div>

    
    <img src="css/Images/design1.png" alt="Design" class="design1">

    <div class="container2">
    	<div class="in-container1">
    		<img src="css/Images/logo2.png" alt="Logo" class="logo2">
